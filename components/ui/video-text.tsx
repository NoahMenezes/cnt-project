...
export interface VideoTextProps {
  ...
  fontFamily?: string
  /**
   * Font style for the text mask (e.g. "italic", "normal")
   * @default "normal"
   */
  fontStyle?: string
  /**
...
export function VideoText({
  ...
  useEffect(() => {
    const updateSvgMask = () => {
      ...
      const newSvgMask = `<svg xmlns='http://www.w3.org/2000/svg' width='100%' height='100%'><text x='50%' y='50%' font-size='${responsiveFontSize}' font-weight='${fontWeight}' font-style='${fontStyle}' text-anchor='${textAnchor}' dominant-baseline='${dominantBaseline}' font-family='${fontFamily}'>${content}</text></svg>`
  ...
  }, [content, fontSize, fontWeight, fontStyle, textAnchor, dominantBaseline, fontFamily])
